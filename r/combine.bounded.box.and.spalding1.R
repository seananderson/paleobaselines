...
d.eco.filled1 <- d.eco.filled[!duplicated(d.eco.filled[, c("genus", "group", "match", "PROV_CODE", "PROVINCE", "RLM_CODE", "REALM", "ALT_CODE", "ECO_CODE_X", "Lat_Zone")]), ] # remove duplicates (i.e., remove extra grid cells)
