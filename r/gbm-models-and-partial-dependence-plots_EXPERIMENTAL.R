...
run_ml_models <- function(x) {
 ...
 train_data <- training_data
  ...
  preds <- data.frame(train_stage,predict_class,predict_group,predict_genus,Ext.Prob)
...
training_data <- drop.levels(subset(training_data,training_data$stage=="Middle Miocene"))
