...
p1 <- ggplot(partial_continuous_culled, aes(value, median_shifted, colour = preservation_cutoff, group = preservation_cutoff)) + geom_line(lwd = 1.8) + facet_wrap(~predictor, scales = "free_x", nrow = 2) + theme_bw() + ylab("Marginal effect on probability of extinction") + xlab("Value") + ylim(-0.5, 0.5)
ggsave("../figs/fossil-cull-comparison-continuous.pdf", width = 12, height = 5)

p2 <- ggplot(partial_groups_culled, aes(median, value, fill = preservation_cutoff, group = preservation_cutoff)) + geom_point(cex = 3, pch = 21, col = "black") + theme_bw() + scale_fill_continuous(name = "Preservation threshold") + xlab("Marginal effect on probability of extinction") + ylab("")
...
p1 <- ggplot(ne_sum, aes(value, N, colour = prop_comp_thresh, group = prop_comp_thresh)) + geom_line(lwd = 1.5) + facet_wrap(~variable, scales = "free_x", nrow = 2) + labs(colour = ">= preservation probability") + theme_bw() + ylab("Number of genera")
p2 <- ggplot(ne_sum, aes(value, N_ex, colour = prop_comp_thresh, group = prop_comp_thresh)) + geom_line(lwd = 1.5) + facet_wrap(~variable, scales = "free_x", nrow = 2) + labs(colour = ">= preservation probability") + theme_bw() + ylab("Number of extinct genera")
p3 <- ggplot(ne_sum, aes(value, N_ex/N, colour = prop_comp_thresh, group = prop_comp_thresh)) + geom_line(lwd = 1.5) + facet_wrap(~variable, scales = "free_x", nrow = 2) + labs(colour = ">= preservation probability") + theme_bw() + ylab("Proportion of extinct genera")
