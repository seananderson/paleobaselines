...
stcen <- droplevels(subset(stcen, stcen$stage_top < 22 &
    stcen$stage_top != 0))
@
...
# make the figure:
pdf("../figs/class-risk-maps-mean-log-ext.pdf", width = 6.25, height = 5.5)
