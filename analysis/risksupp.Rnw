...
We can re-create Fig.~1 in the paper, which is a more customized version of the previous plots, by running the code in .

<<partial-plots-base, child='make-partial-dependence-plot.Rnw', echo=FALSE, results=FALSE>>=
@
...
<<merge-predictions-spatial, child='merge-predictions-spatial-child.Rnw'>>=
@
