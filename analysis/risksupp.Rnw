...
<<plot-density-risk-by-province, fig.width=17, fig.height=13, fig.cap="The distribution of intrinsic extinction risk by biogeographic province \\cite{spalding2007} (panels) and taxonomic class (colors). Note the log transformed x-axis.", echo=FALSE>>=
...
ggplot(by.prov.classes.long,
  ...
  facet_wrap(variable~class, ncol=5, scales = "free") +
