...
To evaluate the effects of the within-realm bounding box interpolation, we created a version of Fig.~1 and 2 that omits this step (Fig.~\ref{fig:no-bounding-box}). This figure shows the same broad patterns apparent in Fig.~1 and 2, but with greater unevenness between provinces. This reflects a combinations of actual differences in intrinsic risk among provinces and apparent differences caused by differences in sampling intensity. Comparing this figure to TODO: finish this
