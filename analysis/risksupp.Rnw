...
In order to ensure (1) that the fossil and modern datasets included only truly marine groups, and (2) that the higher taxonomic categories used as predictors were consistent, 
