...
<<plot-density-risk-by-province, fig.width=13, fig.height=15.5, fig.cap="The distribution of intrinsic extinction risk by biogeographic province \\cite{spalding2007} (panels) and taxonomic class (colors). Note the log-transformed x-axis.", echo=FALSE>>=
