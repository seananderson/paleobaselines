...
\centering
  ...
  \caption{The geographic distribution of \textbf{intrinsic risk residuals after applying a linear model accounting for the number of OBIS records}. Panels for sharks and mammals are not shown because we used range maps instead of OBIS data for the modern distributions.}
