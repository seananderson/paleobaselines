...
<<plot-density-risk-by-province, fig.width=12.5, fig.height=15, fig.cap="The distribution of intrinsic extinction risk by biogeographic province \\cite{spalding2007} (panels) and taxonomic class (colors). Note that the x-axis is log-transformed.", echo=FALSE>>=
