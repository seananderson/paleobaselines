...
val_test <- rdply(30, validate_gbm(stcen, shrinkage = 0.1,
...
val_test <- rdply(150, validate_gbm(stcen2, shrinkage = 0.1,
...
<<plot-density-risk-by-province, fig.width=17, fig.height=13, out.width="7in">>=
