...
<<plot-gcd-genera-prov, fig.cap="Spatial distribution of the \\textbf{mean great circle distance of range size} in the contemporary dataset.", fig.width=6.25, fig.height=4.8, out.width="6in">>=
...
<<plot-richness-genera-prov, fig.cap="Spatial distribution of the \\textbf{mean species richness} in the contemporary dataset.", fig.width=6.25, fig.height=4.8, out.width="6in">>=
