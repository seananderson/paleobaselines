...
<<test-gbm1>>=
val_test <- rdply(100, validate_gbm(neog, shrinkage = 0.05,
...
TODO - add proper axis labels below:
...
<<jackknife-map, fig.cap="Jackknife plot. TODO Fill in this caption.", fig.width=7, fig.height=9, out.width="7in">>=
