...
#
# val_test_plot <- val_test_1.0[sample(1:nrow(val_test_1.0), size = 1000), ]
# p <- ggplot(val_test_summarized_1.0,
#   aes(gbm_pred_binned, mean_observed)) +
#   geom_point(data = val_test_plot, aes(gbm_pred_binned, obs_ext_prob),
#     alpha = 0.08) +
#   geom_linerange(aes(ymin = l, ymax = u), colour = "#4E9DF0") +
...
# p
#
# val_test_plot <- val_test_sing[sample(1:nrow(val_test_sing), size = 1000), ]
# p <- ggplot(val_test_summarized_sing,
#   aes(gbm_pred_binned, mean_observed)) +
#   geom_point(data = val_test_plot, aes(gbm_pred_binned, obs_ext_prob),
#     alpha = 0.08) +
#   geom_linerange(aes(ymin = l, ymax = u), colour = "#4E9DF0") +
...
# cross_pred <- mdply(stage_df, fit_interval_gbm, dat = subset(neog, prop_comp == 1),
# cross_pred <- mdply(stage_df, fit_interval_gbm,
#   dat = subset(neog, prop_comp == 1 & single_obs == 0),
