...
col_box_key <- function(col.pal = brewer.pal(9, "YlOrRd"), limits =
  ...
  = 10, bg = "grey60", border.col = "grey30", at = c(-3, -1.5, 0), add_locator = FALSE, loc_limits = c(-999, 999), loc_col = "grey60", loc_width = 1.5, col.border.col = "grey60", limit_pad = 0.55, at.labels = c(-999, 999), ...) {
  ...
  # border on the colours:
  #rect(0, col.regions[1], width, col.regions[N], border = col.border.col)
