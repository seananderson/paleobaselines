...
extract_ranges <- function() {
  ...
  byGenus.OBIS <- ddply(OBIS.grid.2[1:10000,],
  ...
  pbdb$stage <- ifelse(pbdb$ma_max <= 5.333 & pbdb$ma_min >= .0117,"Plio-Pleistocene",
    ifelse(pbdb$ma_max <= 11.608 & pbdb$ma_min >= 5.333,"Upper Miocene",
      ifelse(pbdb$ma_max <= 15.97 & pbdb$ma_min >= 11.608,"Middle Miocene",
        ifelse(pbdb$ma_max <= 23.03 & pbdb$ma_min >= 15.97,"Lower Miocene",
          NA))))
